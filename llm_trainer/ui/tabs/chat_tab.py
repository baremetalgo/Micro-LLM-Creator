...
def build_chat_tab(window) -> QWidget:
    ...
    model_form.addRow("GGUF model", window._path_row(window.gguf_path, directory=False, file_filter="GGUF models (*.gguf);;All files (*)"))
    ...
    window._tip(window.load_llm_button, "Load the GGUF model into memory once for repeated chat messages.")
